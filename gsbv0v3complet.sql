...
('AMOPIL7', 5, 1, '500mg 3 fois par jour si nécessaire'),
...
('a131', 3, '2021-12-03', 'Médecin énervé, ancien boxeur !', NULL, NULL, NULL, NULL, NULL, 7),
('a17', 1, '2003-05-21', 'Changement de direction, redéfinition de la politique médicamenteuse, recours au générique.', NULL, NULL, NULL, NULL, NULL, 4);
...
--
ALTER TABLE `offrir`
  ADD CONSTRAINT `offrir_med_FK` FOREIGN KEY (`MED_DEPOTLEGAL`) REFERENCES `medicament` (`MED_DEPOTLEGAL`),
